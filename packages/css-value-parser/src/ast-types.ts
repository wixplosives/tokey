...
export type Frequency = Unit<
  `<frequency>`,
  AnyCase<typeof frequencyValidUnits[number]>
>;
export type Resolution = Unit<
  `<resolution>`,
  AnyCase<typeof resolutionValidUnits[number]>
>;
// other
...
export const length = (
  value: Partial<Length> & Pick<Length, "unit">
): Length => ({
  start: 0,
  end: 0,
  value: `0`,
...
export const frequency = (
  value: Partial<Frequency> & Pick<Frequency, "unit">
): Frequency => ({
  start: 0,
  end: 0,
  value: `0`,
...
export const resolution = (
  value: Partial<Resolution> & Pick<Resolution, "unit">
): Resolution => ({
  start: 0,
  end: 0,
  value: `0`,
